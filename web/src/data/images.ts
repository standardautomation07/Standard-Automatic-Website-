...
const list: ImageRef[] = [
  ...
  visualised(
    ...
    "hero",
    "A windproof rolling shutter closed across a wide vehicle opening in a modern light-grey clad commercial building, seen in three-quarter view: a curtain of slim curved interlocking steel slats in matte anthracite between deep matching guide channels, a flat reinforced bottom bar on the concrete apron and a slim rectangular hood above, in soft late-afternoon light",
    "Windproof / Storm-Resistant Rolling Shutter — lead image",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
    "shutter-windproof-slat-detail",
    "rolling-shutters",
    "windproof-rolling-shutters",
    "slat-detail",
    "Macro view of the windproof shutter curtain: slim curved interlocking galvanised steel slats in matte anthracite powder coat, the rolled interlock joint between each slat and a flush steel end lock at the slat end",
    "Windproof / Storm-Resistant Rolling Shutter — reinforced interlocking curtain",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
    "shutter-windproof-side-guide",
    "rolling-shutters",
    "windproof-rolling-shutters",
    "side-guide",
    "Close-up at the jamb of the windproof shutter: the deep anthracite wind-resistant guide channel anchor-bolted to the concrete reveal, the curved slats running into it, flat wind-lock plates riveted flush to the slat ends and small rivet end locks on the slats between",
    "Windproof / Storm-Resistant Rolling Shutter — wind-resistant guide, wind locks and end locks",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
    "shutter-windproof-bottom-profile",
    "rolling-shutters",
    "windproof-rolling-shutters",
    "bottom-profile",
    "Floor-level close-up of the windproof shutter's reinforced flat-fronted anthracite bottom bar with its black rubber floor seal on a pale concrete threshold, the lowest curved slats above it and the bar running into the guide channel at the jamb, rain-wet concrete outside",
    "Windproof / Storm-Resistant Rolling Shutter — reinforced bottom bar and floor seal",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
    "shutter-windproof-drive-assembly",
    "rolling-shutters",
    "windproof-rolling-shutters",
    "drive-assembly",
    "The head of the windproof shutter seen from inside with the hood removed: the anthracite curtain coiled on a heavy steel shaft carried on steel end plates bolted to the structure, with a compact geared drive and its manual override chain at one end",
    "Windproof / Storm-Resistant Rolling Shutter — heavy-duty shaft, end plates and drive with manual override",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
    "shutter-windproof-installed",
    "rolling-shutters",
    "windproof-rolling-shutters",
    "installed",
    "A windproof rolling shutter closed on the exposed loading elevation of a modern grey-clad logistics building under a moving overcast sky, light rain on the concrete apron and wind-bent grasses at its edge, the anthracite curtain, guides and hood standing calm and stable",
    "Windproof / Storm-Resistant Rolling Shutter — installed on an exposed elevation",
    "research/windproof-shutter-visual-definition.md",
  ),
  visualised(
