...
export const rollingShutterProducts: Product[] = [
  ...
  /* ==================================================== 04 ALUMINIUM */
  {
    ...
    galleryIds: ["p-shutter-aluminium"],
  ...
  /* ==================================================== 05 STAINLESS */
  {
    ...
    galleryIds: ["p-shutter-stainless"],
  ...
  /* =================================================== 06 PERFORATED */
  {
    ...
    imageId: "shutter-perforated-supplied",
    galleryIds: ["p-shutter-perforated"],
  ...
  /* ================================================ 09 POLYCARBONATE */
  {
    ...
    galleryIds: ["p-shutter-polycarbonate"],
