/**
 * Trusted Partners — the master organisation dataset: every organisation
 * Standard Automatic Solutions has delivered or is delivering projects with.
 * This file is the single source of truth for the public Trusted Partners
 * section (src/components/clients/trusted-partners.tsx).
 *
...
/**
 * How the organisation relates to Standard Automatic Solutions. INTERNAL
 * ONLY — the public Trusted Partners section never shows it. The PDF column
 * is just "Client name", so the classification is a best reading of the
 * organisation's business; "pending" means it could not be classified with
 * confidence.
 */
export type Relationship = "contractor" | "end-user" | "project-partner" | "pending";
...
export const clientOrganisations: ClientOrganisation[] = [
  ...
  /* ---- Organisations from the previous website's client page ---- */
  {
    ...
    logo: "/images/clients/zf-india.svg",
    initials: "ZF",
    ...
    projects: [],
    reviewNotes: ["Listed on the previous website's client page; no project rows in the March 2026 client list."],
  },
  {
    id: "monier",
    relationship: "end-user",
    ...
    listedOnWebsite: true,
    projects: [],
    reviewNotes: ["Colour logo carried over from the previous website's client page (110×80 source); a higher-resolution official asset could not be retrieved automatically. No project rows in the March 2026 client list."],
  },
  {
    id: "john-deere",
    relationship: "end-user",
  ...
  },
  {
    ...
    logo: "/images/clients/lmt-tools.svg",
    initials: "LMT",
  ...
  },
  {
    ...
    logo: "/images/clients/tech-mahindra.svg",
    initials: "TM",
  ...
  },
  {
    ...
    logo: "/images/clients/thermax.svg",
    initials: "TX",
  ...
  },
  {
    ...
    listedOnWebsite: true,
    projects: [],
    reviewNotes: ['"Revati" as shown on the previous website; full organisation name not recorded — confirm.', "Colour logo carried over from the previous website's client page (110×80 source); a higher-resolution official asset could not be retrieved automatically. No project rows in the March 2026 client list."],
  },
  {
    id: "amazon",
    relationship: "end-user",
  ...
  },
  {
    ...
    logo: "/images/clients/wienerberger.svg",
    initials: "WB",
...
export const clientStats = (() => {
  ...
  return {
    ...
    contractors: clientOrganisations.filter((o) => o.relationship === "contractor").length,
    endUsers: clientOrganisations.filter((o) => o.relationship === "end-user").length,
    projectPartners: clientOrganisations.filter((o) => o.relationship === "project-partner").length,
    pendingClassification: clientOrganisations.filter((o) => o.relationship === "pending").length,
  };
})();
