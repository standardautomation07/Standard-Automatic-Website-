...
const base =
  "inline-flex items-center justify-center gap-2.5 rounded-edge font-medium transition-[background-color,border-color,color,transform] duration-200 active:translate-y-px " +
...
const variants: Record<Variant, string> = {
  primary: "bg-amber text-white hover:bg-amber-deep font-semibold",
  secondary:
